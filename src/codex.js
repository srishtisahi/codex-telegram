...
function buildPrompt({
  ...
  return [
    ...
    "Always add planned tasks to Linear before starting execution work.",
    "Execute planned tasks one by one and update Linear task status/progress while work is ongoing, not only at the end.",
    "If new work appears during execution, add follow-up tasks to Linear immediately and continue tracking progress.",
    "Do not prefix Linear task titles with session id.",
    "Create or reuse one Linear project for the active effort with a title of at most 5 words.",
    "In that Linear project short summary, include the active session id for reference.",
